...
export const chatter_name = document.querySelector('#chatter_name') // choser user for chatting reference
...
export const choose_chat_btn = document.querySelector('#choose_chat_btn') // button for accepting chosen user for chatting reference
